...
if st.button("PREDICT WINNING PROBABILITY"):
    ...
    with col1:
        ...
        # Ensure that the column order and names match the expected input format
        input_data = input_data[['batting_team', 'bowling_team', 'venue', 'runs_left', 'balls_left',
                                 'wickets_remaining', 'total_runs_x', 'CRR', 'RRR']]

        #result=pipe.predict_proba(input_data)
        result = decision_tree_model.predict_proba(input_data)
